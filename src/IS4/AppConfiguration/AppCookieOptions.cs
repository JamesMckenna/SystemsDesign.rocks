...
namespace IS4.AppConfiguration
{
    ...
    internal static class SameSiteCookiesServiceCollectionExtensions
    {
        #region - https://github.com/IdentityServer/IdentityServer4/issues/4165
        /// <summary>
        ...
        private static bool DisallowsSameSiteNone(string userAgent)
        {
            ...
            #region - https://github.com/IdentityServer/IdentityServer4/issues/4165
            static int GetChromeVersion(string userAgent)
            {
                try
                {
            ...
            if (chromeVersion >= 80)
            {
                return false;//this was true, I set it to return false
            }
            #endregion
